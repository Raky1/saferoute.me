...
<body>
    ...
    <div id="map" style="height :500px; margin-top: 45px;"></div>
    
<div class="form-roubo">
    <form autocomplet=off action="occurrence/insert" method="POST">

        <input id=input_address placeholder="Endereço" type=text name=address value="<?php if(isset($_SESSION['occurrence']['address'])) echo $_SESSION['occurrence']['address']; ?>" readonly required>
        <br>

        <input id=input_latitude placeholder="Latitude" type=text name=latitude value="<?php if(isset($_SESSION['occurrence']['latitude'])) echo $_SESSION['occurrence']['latitude']; ?>" readonly required>
        <br>

        <input id=input_longitude placeholder="Logitude" type=text name=longitude value="<?php if(isset($_SESSION['occurrence']['longitude'])) echo $_SESSION['occurrence']['longitude']; ?>" required readonly>
        <br>

        <input id=input_day placeholder="Dia" type=date name=day value="<?php if(isset($_SESSION['occurrence']['day'])) echo $_SESSION['occurrence']['day']; ?>" required>
        <br>

        <input id=input_time placeholder="Hora" type=time name=time value="<?php if(isset($_SESSION['occurrence']['time'])) echo $_SESSION['occurrence']['time']; ?>" required>
        <br>
        ...
        <input type=text placeholder="Complemento" name=complement value="<?php if(isset($_SESSION['occurrence']['complement'])) echo $_SESSION['occurrence']['complement']; ?>">
        <br>

        <!-- email for controller -->
        <input id=email placeholder="Email" type=email name=email value="<?php if(isset($_SESSION['occurrence']['email'])) echo $_SESSION['occurrence']['email']; ?>" required>
        <br>
